using Net6Fundamentals.TagHelpers;
using Microsoft.AspNetCore.Razor.TagHelpers;
using Moq;

namespace Net6FundamentalsTests.TagHelpers
{
    public class EmailTagHelperTests
    {
        ...
        {
            EmailTagHelper emailTagHelper = new EmailTagHelper() { Address = "test@shop.com", Content = "Email" }; ;
            ...
            Assert.Equal("mailto:test@shop.com", tagHelperOutput.Attributes[0].Value);
        }
